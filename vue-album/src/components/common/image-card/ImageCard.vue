    ...
    <div class="relative flex flex-col gap-3">
      <Dialog>
        <DialogTrigger as-child>
          <Button
            size="icon"
            class="absolute top-2 right-2 bg-neutral-500 bg-opacity-50 hover:bg-black hover:bg-opacity-50 cursor-pointer"
          >
        ...
        <DialogContent class="sm:max-w-xl">
          <DialogHeader>
            ...
            <DialogDescription
              >선택한 이미지의 상세정보를 확인하세요.</DialogDescription
            >
          </DialogHeader>
          <div class="flex flex-col items-center space-x-2 gap-3">
            ...
            <div class="flex flex-col w-full gap-2">
              ...
              <div class="flex items-start">
                ...
                <small class="text-sm font-medium leading-4">{{
                  image.description
                    ? image.description
                    : "등록된 묘사 및 설명글이 없습니다."
                }}</small>
            ...
            <div class="flex items-center justify-end w-full gap-4">
              ...
              <div class="flex items-center gap-1 text-sm">
                <Heart
                  class="h-[14px] w-[14px] mt-[2px] text-rose-600"
                  fill="#e11d48"
                />
